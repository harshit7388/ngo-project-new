  ...
  const pastEvents = [
    {
      ...
      description: "Provided educational materials and conducted workshops for underprivileged students especially for girls",
    ...
    <div>
      ...
      >
        <div className="container text-white">
          ...
          <p className="text-xl max-w-2xl">Partner with us to create meaningful impact through corporate social responsibility.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-12">
              We work with corporations to design and implement impactful CSR programs that align with both corporate objectives and community needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-3">Structured Programs</h3>
              <p className="text-gray-600">
                Well-planned initiatives with clear objectives and measurable outcomes.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Opportunities for corporate employees to participate and contribute directly.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-12">Past CSR Events</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pastEvents.map((event, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <Link to="/contact" className="text-teal-600 font-medium flex items-center hover:text-teal-700">
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8">
              Looking to make a difference through your corporate social responsibility initiatives? 
              We offer customized programs that align with your company's values and objectives.
            </p>
